...
async def create_lead(
    ...
    return StandardResponse[LeadOut, None](
        Success=True,
...
async def list_leads(
    ...
    return StandardResponse[List[LeadOut], PaginationMetadata](
        Success=True,
...
async def leads_stats(
    ...
    return StandardResponse[LeadStats, None](
        Success=True,
...
async def ai_summary(
    ...
    return StandardResponse[dict, None](
        Success=True,
